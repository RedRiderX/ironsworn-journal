<template>
  <section
    class="reference-section p-2 border-b-4 border-gray-100"
    :class="{ collapsed: isCollapsed }"
  >
    <header class="sticky top-0 bg-gray-200 flex justify-between items-center mb-1" @click="isCollapsed = !isCollapsed">
